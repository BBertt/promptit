...
// If a model named "User" already exists in the "models" object, it
...
const User = models.User || model("User", UserSchema); // do this if we are doing an always running backend server that uses regexp.

// models.User ||, it will look into the models.User and see if the User model is there and if it is not there it will then do the following function.
